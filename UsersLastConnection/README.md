💡 Displays on profiles if users are online — otherwise shows “Last seen … ago.” Works on profiles & popouts. Language selectable in plugin settings (default English).
